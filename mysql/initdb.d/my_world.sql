...
CREATE TABLE `cities` (
  ...
  CONSTRAINT `cities_ibfk_1` FOREIGN KEY (`country_code`) REFERENCES `country` (`Code`)
...
(184,'Belize cities','BLZ','Belize cities',55810),
...
(1100,'Bokaro Steel cities','IND','Jharkhand',333683),
...
(2765,'Benin cities','NGA','Edo & Delta',229400),
...
(3580,'Moscow','RUS','Moscow (cities)',8389200),
...
(3667,'Zelenograd','RUS','Moscow (cities)',207100),
...
(3769,'Ho Chi Minh cities','VNM','Ho Chi Minh cities',3980000),
...
(3821,'Oklahoma cities','USA','Oklahoma',506132),
...
(3828,'Kansas cities','USA','Missouri',441545),
...
(3864,'Jersey cities','USA','New Jersey',240055),
...
(3898,'Boise cities','USA','Idaho',185787),
...
(3903,'Salt Lake cities','USA','Utah',181743),
...
(3936,'Kansas cities','USA','Kansas',146866),
...
(4004,'West Valley cities','USA','Utah',108896),
...
(4020,'Daly cities','USA','California',103621),
...
CREATE TABLE `countries` (
  ...
  `indep_year` smallint DEFAULT NULL Comment '独立記念日',
  `population` int NOT NULL DEFAULT '0' Comment '人口',
  ...
  `capital` int DEFAULT NULL Comment '首都',
...
CREATE TABLE `country_languages` (
  ...
  KEY `country_code` (`country_code`),
  CONSTRAINT `country_languages` FOREIGN KEY (`country_code`) REFERENCES `country` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'Emma Charlotte Duerre Watson','FRA', '1990-4-15', 31, 'actor'),
(2,'Johnny Depp','USA', '1963-6-9', 58, 'actor'),
(3,'Jim Carrey','USA', '1962-1-17', 59, 'actor'),
(4,'Daniel Radcliffe','GBR', '1989-7-23', 32, 'actor'),
(5,'Morgan Freeman','USA', '1937-6-1', 84, 'actor'),
(6,'Hugh Jackman','AUS', '1968-10-12', 53, 'actor'),
(7,'Natalie Portman','', '1981-6-9', 40, 'actor'),
(8,'Pierce Brosnan','FRA', '1960-10-15', 61, 'actor'),
(9,'Sean Connery','PER', '1980-5-5', 41, 'singer'),
(10,'Dwayne Johnson','USA', '1978-12-15', 43, 'fighter'),
(11,'Jackie Chan','USA', '1992-4-15', 29, 'fighter'),
(12,'Adam Sandler','FRA', '1976-2-5', 45, 'singer'),
(13,'Scarlett Johansson','AUT  ', '1966-1-10', 55, 'model'),
(14,'Heath Ledger','USA', '1971-10-15', 50, 'actor'),
(15,'Edward Norton','GBR', '1988-3-12', 33, 'actor'),
(16,'Keira Knightley','GBR', '1980-11-10', 41, 'model'),
(17,'Bradley Cooper','USA', '1979-8-1', 42, 'fighter'),
(18,'Will Ferrell','USA', '1966-1-15', 53, 'comedian'),
(19,'Julia Roberts','GRC', '1964-9-1', 55, 'actor'),
(20,'Daniel Craig','USA', '1977-12-9', 44, 'actor'),
(21,'Ian McKellen','', '1998-4-15', 23, 'singer'),
(22,'Samuel L. Jackson','USA', '1960-4-9', 61, 'actor'),
(23,'Ben Stiller','BRA', '1964-10-15', 57, 'actor'),
(24,'Tommy Lee Jones','', '1970-9-5', 51, 'comedian'),
(25,'Antonio Banderas','USA', '1958-10-5', 63, 'actor'),
(26,'Denzel Washington','USA', '1990-10-25', 31, 'model'),
(27,'Steve Carell','USA', '1991-2-14', 30, 'actor'),
(28,'Shia LaBeouf','CHL', '1991-10-5', 30, 'actor'),
(29,'Megan Fox','GRC', '1992-9-23', 29, 'actor'),
(30,'James Franco','USA', '1955-4-15', 66, 'actor'),
(31,'Mel Gibson','COL', '1967-3-8', 54, 'singer'),
(32,'Vin Diesel','USA', '1982-11-15', 39, 'singer'),
(33,'Tim Allen','ISL', '1962-2-10', 59, 'actor'),
(34,'Kevin Spacey','USA', '1990-4-15', 31, 'actor'),
(35,'Jason Biggs','USA', '1979-3-25', 42, 'actor'),
(36,'Seann William Scott','USA', '1957-2-22', 64, 'actor'),
(37,'Jean-Claude Van Damme','USA', '1997-1-10', 24, 'model'),
(38,'Zach Galifianakis','USA', '1969-4-22', 52, 'actor'),
(39,'Owen Wilson','USA', '1988-6-5', 31, 'actor'),
(40,'Christian Bale','USA', '1977-12-1', 44, 'actor'),
(41,'Peter Jackson','USA', '1994-10-25', 27, 'model'),
(42,'Sandra Bullock','CUA', '1975-7-19', 46, 'actor'),
(43,'Drew Barrymore','USA', '1993-6-5', 28, 'singer'),
(44,'Macaulay Culkin','ESP', '1981-7-22', 40, 'comedian'),
(45,'Bill Murray','USA', '1988-3-9', 33, 'actor'),
(46,'Sigourney Weaver','FIN', '1954-12-10', 67, 'actor'),
(47,'Jake Gyllenhaal','', '1990-5-5', 31, 'model'),
(48,'Jason Statham','USA', '1986-6-8', 35, 'actor');
commit;
